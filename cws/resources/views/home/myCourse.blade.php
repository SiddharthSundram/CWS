                                ...
                                response.courses.forEach((item) => {
                                    ...
                                    let courseSection = $(`
                                        <div class="bg-white rounded-lg shadow-lg p-6 flex flex-col md:flex-row items-center justify-center mb-5 border border-b">
                                            ...
                                            <div class="mt-4 flex items-center justify-center">
                                                <button class="flex gap-1 bg-green-500 hover:bg-green-600 text-white font-semibold px-6 py-3 rounded-md shadow-md transition-colors duration-300 ml-4 download-invoice-btn">
                                    ...
                                    courseSection.find('.download-invoice-btn').click(
                                        function() {
                                            ...
                                            var gstRate =
                                                0.18; // Assuming GST rate is 18%
                                            var totalFees = fees * (1 +
                                                gstRate); // Adding GST
                                    ...
                                    function generatePaymentDetails(payments) {
                                        if (payments && payments.length > 0) {
                                            ...
                                            return "<tr><td colspan='2'><p class='mt-2'>No payment information available.</p></td></tr>";
                                        }
                                    }
