...
<div class="container mx-auto py-12 h-screen">
    <h1 class="text-4xl font-bold text-center mb-8">All Projects</h1>

    <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-2 gap-8" id="callingrecentProject">
        <!-- Project Card 1 -->              
    </div>
</div>
            ...
            function callingrecentProject() {
                $.ajax({
                    ...
                    data.forEach((project) => {
                        container.append(`                     
                        <div class="project-card bg-white shadow-sm rounded-lg overflow-hidden ">
                            <div class="p-6">
