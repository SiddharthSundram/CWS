    ...
    <aside id="logo-sidebar"
        ...
        <div class="h-full px-3 pb-4 overflow-y-auto text-white bg-[#0b7d99] dark:bg-gray-800">
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <button type="button"
                        class="flex items-center w-full p-2 text-base text-gray-200 hover:text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-200"
                        aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">

                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="flex-shrink-0 w-5 h-5 text-gray-200 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-gray-900"
                            viewBox="0 0 576 512">
                            <path fill="currentColor"
                    ...
                    <ul id="dropdown-example" class="hidden py-2 space-y-2">
                        ...
                        <li>
                            <a href="#"
                                class="flex items-center w-full p-2 text-gray-200 hover:text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-200">Web
                                Devlopment</a>
                        </li>
                        <li>
                            <a href="#"
                                class="flex items-center w-full p-2 text-gray-200 hover:text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-200">Machine
                                Learning</a>
                        </li>
                        <li>
                            <a href="#"
                                class="flex items-center w-full p-2 text-gray-200 hover:text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-200">Android
                                Devlopment</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="{{ route('myCourse') }}"
                        class="flex items-center p-2 text-gray-200 hover:text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-200 group course-link">
                ...
                <li>
                    <a href="{{ route('profile') }}"
                        class="flex items-center p-2 text-gray-200 hover:text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-200 group profile-link">
                ...
                <li>
                    <a href="{{ route('login') }}"
                        class="flex items-center p-2 text-gray-200 hover:text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-200 group login-link">
                        <svg class="flex-shrink-0 w-5 h-5 text-gray-200 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-gray-900"
                ...
                <li>
                    <a href="{{ route('register') }}"
                        class="flex items-center p-2 text-gray-200 hover:text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-200 group register-link">
                        <svg class="flex-shrink-0 w-5 h-5 text-gray-200 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-gray-900"
                ...
                <li>
                    <a href=""
                        class="flex items-center p-2 text-gray-200 hover:text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-200 group logout-link">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="flex-shrink-0 w-5 h-5 text-gray-200 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-gray-900"
                            viewBox="0 0 512 512">
                            <path fill="currentColor"
