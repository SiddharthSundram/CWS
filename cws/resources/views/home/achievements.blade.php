...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4 border-b border-gray-200 dark:border-slate-600 py-4 px-6" id="callingHallframe">
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    data.forEach((hallFrame) => {
                        container.append(`
                        <div class="flex items-center justify-center md:justify-start w-full border border-gray-200 dark:border-slate-600  p-1">
