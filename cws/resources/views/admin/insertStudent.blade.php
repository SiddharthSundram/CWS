@extends('admin.base')
@section('title')
<title>@yield('title') Admin | Insert Student</title>
@endsection
            ...
            <div class="bg-white shadow-lg rounded-lg">
                <div class="bg-gray-200 flex justify-between px-4 py-2 rounded-t-lg">
                    ...
                    <a href="{{ route('manageStudent') }}"
                        class=" flex justify-end py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-gray-700 hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Go
                        Back</a>
